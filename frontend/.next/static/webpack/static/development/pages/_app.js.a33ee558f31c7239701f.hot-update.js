...
})(["position:relative;.count{display:block;position:relative;transition:all 0.4s;backface-visibility:hidden;}.count-enter{transform:rotateX(0.5turn);}.count-enter-active{transform:rotateX(0);}.count-exit{top:0;position:absolute;transform:rotateX(0);}.count-exit{transform:rotateX(0.5turn);}"]);
...
var CartCount = function CartCount(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(AnimationStyles, {
    ...
    __self: this
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(CSSTransition, {
    className: "count",
    classNames: "count",
    key: "count",
    timeout: {
...
//# sourceMappingURL=_app.js.a33ee558f31c7239701f.hot-update.js.map